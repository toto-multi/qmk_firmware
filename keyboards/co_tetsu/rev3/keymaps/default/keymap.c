...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ENG_] = LAYOUT(
    ...
    KC_3   ,  XXXXXXX,  XXXXXXX,  KC_0   ,  KC_9   , XXXXXXX,     XXXXXXX,  KC_8   ,  KC_7   ,  XXXXXXX,  XXXXXXX,  KC_4   ,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  ___T_L2, ___T_L3,     ___T_R3,  ___T_R2,  ___T_R1,  XXXXXXX,  ___JPN_,  XXXXXXX
  ),
  ...
  [_JPN_] = LAYOUT(
    ...
    _______,  _______,  _______,  _______,  _______, _______,     _______,  _______,  _______,  _______,  ___ENG_,  _______
  ),
