...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ENG_] = LAYOUT(
    ...
    KC_3   ,  XXXXXXX,  XXXXXXX,  KC_0   ,  KC_9   , ___T_L4,     ___T_R4,  KC_8   ,  KC_7   ,  XXXXXXX,  XXXXXXX,  KC_4   ,
    XXXXXXX,  ___ENG_,  XXXXXXX,  ___T_L1,  ___T_L2, ___T_L3,     ___T_R3,  ___T_R2,  ___T_R1,  XXXXXXX,  ___JPN_,  XXXXXXX
  ),
  ...
  [_SYM_] = LAYOUT(
    ...
    _______,  _______,  _______,  _______,  _______, _______,     _______,  _______,  _______,  _______,  _______,  _______,
    _______,  ___CMD_,  _______,  _______,  _C_PGUP, _C_PGDN,     _______,  _______,  _______,  _______,  _______,  _______
  ), 

  [_CMD_] = LAYOUT(
    _______,  ___UNDO,  ___ADRS,  _______,  _______, _______,     _______,  _______,  _______,  ___CPCM,  _A_F7__,  _______,
    CT_PSWD,  ___ALL_,  KC_F2  ,  ___REDO,  ___CLSE, _______,     _______,  _A_F1__,  _A_F2__,  ___CPHS,  _A_F3__,  _A_F8__,
    ...
    _______,  _______,  _______,  _______,  _______, _______,     KC_DEL ,  CT_ESC ,  ___SAVE,  _______,  ___SYM_,  _______
  ),
};
